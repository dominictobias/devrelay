...
On first run, DevRelay will automatically generate certificates, install its CA to your system trust store, and add your domains to `/etc/hosts`. Restart your browser and visit `https://myapp.dev`. If you have a server running on `http://localhost:3000` it will be loaded.
